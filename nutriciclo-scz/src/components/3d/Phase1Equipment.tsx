...
export function Phase1Equipment({ hideLabels = false }: { hideLabels?: boolean }) {
  ...
  return (
    <group position={[-14, 0, 0]}>
      {!hideLabels && <Text position={[5, 3.8, 0]} fontSize={0.4} color="#fca5a5" anchorX="center">
      ...
      <group position={[0, 0, 0]}>
        ...
        {!hideLabels && <Html position={[0, -1.3, 0]} center>
      ...
      <group position={[2.5, 0.2, 0]}>
        ...
        {!hideLabels && <Html position={[0, -1.1, 0]} center>
          <div style={{ color: '#fca5a5', fontSize: '10px', whiteSpace: 'nowrap', textAlign: 'center', pointerEvents: 'none', lineHeight: 1.4 }}>
      ...
      <group position={[5, -0.5, 0]}>
        ...
        {!hideLabels && <Html position={[0, -0.5, 0]} center>
          <div style={{ color: '#fca5a5', fontSize: '10px', whiteSpace: 'nowrap', textAlign: 'center', pointerEvents: 'none', lineHeight: 1.4 }}>
      ...
      <group position={[7.5, 0.3, 0]}>
        ...
        {!hideLabels && <Html position={[0, -1.2, 0]} center>
          <div style={{ color: '#fca5a5', fontSize: '10px', whiteSpace: 'nowrap', textAlign: 'center', pointerEvents: 'none', lineHeight: 1.4 }}>
      ...
      <group position={[10, 0, 0]}>
        ...
        {!hideLabels && <Html position={[0, -0.9, 0]} center>
          <div style={{ color: '#fca5a5', fontSize: '10px', whiteSpace: 'nowrap', textAlign: 'center', pointerEvents: 'none', lineHeight: 1.4 }}>
