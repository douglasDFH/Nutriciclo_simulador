...
export function Phase1Equipment() {
  ...
  return (
    <group position={[-14, 0, 0]}>
      ...
      {/* Marmita */}
      <group position={[0, 0, 0]} onClick={(e) => toggle('marmita', e)}>
        ...
        {selected === 'marmita' && (
          <Html position={[0, -1.3, 0]} center>
            <div style={{ color: '#fca5a5', fontSize: '10px', whiteSpace: 'nowrap', textAlign: 'center', pointerEvents: 'none', lineHeight: 1.4,
              background: 'rgba(10,10,10,0.85)', padding: '4px 8px', borderRadius: 6, border: '1px solid #ef4444' }}>
      ...
      {/* Secador Rotatorio */}
      <group position={[2.5, 0.2, 0]} onClick={(e) => toggle('dryer', e)}>
        ...
        {selected === 'dryer' && (
          <Html position={[0, -1.1, 0]} center>
            <div style={{ color: '#fca5a5', fontSize: '10px', whiteSpace: 'nowrap', textAlign: 'center', pointerEvents: 'none', lineHeight: 1.4,
              ...
              <span style={{ color: '#9ca3af', fontSize: '8px' }}>0.5–3 t/h · 22 kW · 60–70°C</span><br/>
      ...
      <group position={[5, -0.5, 0]} onClick={(e) => toggle('scinfin', e)}>
        <mesh castShadow>
      ...
      {/* Horno Rotatorio */}
      <group position={[7.5, 0.3, 0]} onClick={(e) => toggle('kiln', e)}>
      ...
      {/* Molino de Martillos */}
      <group position={[10, 0, 0]} onClick={(e) => toggle('mill', e)}>
        <mesh castShadow>
